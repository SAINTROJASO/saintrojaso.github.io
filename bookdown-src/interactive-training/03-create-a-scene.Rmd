...
```{r step-1-1, echo=FALSE, out.width="25%", fig.align="center", fig.cap="Locate Import Videos Path"}
...
```{r step-1-2, echo=FALSE, out.width="50%", fig.align="center", fig.cap="Import Videos Path"}
...
```{r step-1-3, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Check Videos"}
...
```{r step-2-1, echo=FALSE, out.width="25%", fig.align="center", fig.cap="Locate Scenes Path"}
knitr::include_graphics("images/step_2_1.png")
```

2. You should see the following pre-built scenes on the right side of the window: `0_STARTING SCENE`, `1_FIRST_SCENE`, and `LAST SCENE` in the left window of the **Project** panel.

```{r step-2-2, echo=FALSE, out.width="100%", fig.align="center", fig.cap="Create Scenes"}
...
```{r step-2-3, echo=FALSE, out.width="25%", fig.align="center", fig.cap="Locate Path"}
...
```{r step-2-4, echo=FALSE, out.width="75%", fig.align="center", fig.cap="Write Training Instructions"}
